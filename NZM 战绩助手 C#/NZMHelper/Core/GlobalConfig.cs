...
namespace NZMHelper.Core
{
    ...
    {
        public const string CURRENT_VERSION = "V1.6.0";
        ...
        public static Brush GetQualityBrush(int quality)
        {
            ...
            {
                4 => new SolidColorBrush((Color)ColorConverter.ConvertFromString("#d4a84b")),
                3 => new SolidColorBrush((Color)ColorConverter.ConvertFromString("#a855f7")),
                2 => new SolidColorBrush((Color)ColorConverter.ConvertFromString("#3b82f6")),
                _ => new SolidColorBrush((Color)ColorConverter.ConvertFromString("#71717a"))
            };
        }

        public static class Colors
        {
            public static Brush CardBg = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#27272a"));
        ...
        {
            if (MapConfig.TryGetValue(mapId, out var config))
            {
                return config.Mode;
            }
        ...
        public static async Task<BitmapImage> LoadImageAsync(string url)
        {
            ...
            try
            {
                ...
                string hash = BitConverter.ToString(System.Security.Cryptography.MD5.Create().ComputeHash(Encoding.UTF8.GetBytes(url))).Replace("-", "");
